...
public class TopupVoucherCollection {
    private static String separator = "  --  ";

    private static int serviceId = 20001;

    // Cash In service number
    private static String serviceNumber = "242947689";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Voucher Service: " + topup.getServiceid());
            System.out.println("Voucher Description: " + topup.getDescription());
            System.out.println("Voucher Amount: " + topup.getAmountLocalCur());
            System.out.println("Voucher Payment Item Id: " + topup.getPayItemId());
