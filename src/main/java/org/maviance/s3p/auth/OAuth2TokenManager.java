...
/**
 * Mints, caches, and refreshes OAuth 2.0 access tokens via the S3P
...
public final class OAuth2TokenManager {
    ...
    public OAuth2TokenManager(HttpClient httpClient, ObjectMapper jsonMapper, S3pConfig config) {
     ...
     * the cached token is within {@link S3pConfig#tokenRefreshSkew()} of
    ...
    private OAuth2Token mintToken(Instant issuedAt) {
        ...
        try {
            ...
            throw new S3pAuthException(0, null,
        ...
        if (status < 200 || status >= 300) {
            ...
            throw new S3pAuthException(status, oauthError,
    ...
    private OAuth2Token parseTokenResponse(String body, Instant issuedAt) {
        ...
        try {
            ...
            throw new S3pAuthException(200, null,
    ...
    private URI tokenUri() {
        ...
        try {
            ...
            throw new S3pException("Invalid OAuth token URI: " + base + TOKEN_PATH, e);
        }
    }
