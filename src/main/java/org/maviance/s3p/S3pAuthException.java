 ...
 * </ul>
 */
public final class S3pAuthException extends S3pException {
    ...
    public S3pAuthException(int httpStatus, String oauthError, String message) {
        super(message);
        this.httpStatus = httpStatus;
        this.oauthError = oauthError;
    }

    public S3pAuthException(int httpStatus, String oauthError, String message, Throwable cause) {
        super(message, cause);
        this.httpStatus = httpStatus;
        this.oauthError = oauthError;
    }
