...
public class Account {
	 ...
	 * @return balance
	 **/
	@ApiModelProperty(required = true, value = "Remaining amount in account")
	 ...
	 * @return currency
	 **/
	@ApiModelProperty(required = true, value = "Currency of agent balance in system (e.g. XAF)(Format: ISO 4217)")
	 ...
	 * @return key
	 **/
	@ApiModelProperty(required = true, value = "Public Access key")
	 ...
	 * @return agentId
	 **/
	@ApiModelProperty(required = true, value = "Unique Agent Identifier")
	 ...
	 * @return agentName
	 **/
	@ApiModelProperty(required = true, value = "Agent full name")
	 ...
	 * @return agentAddress
	 **/
	@ApiModelProperty(required = true, value = "Agent full address")
	 ...
	 **/
	@ApiModelProperty(required = true, value = "Agent phonenumber")
	 ...
	 * @return companyName
	 **/
	@ApiModelProperty(required = true, value = "Collector company name")
	 ...
	 **/
	@ApiModelProperty(required = true, value = "Collector company address information")
	 ...
	 **/
	@ApiModelProperty(required = true, value = "Collector company phonenumber")
	...
	/**
	 * Daily collection limit – The maximum amount that can be collected per day by
	 * this account.
	 * 
	 * @return limitMax
	 **/
	@ApiModelProperty(required = true, value = "Daily collection limit – The maximum amount that can be collected per day by this account.")
	 ...
	 **/
	@ApiModelProperty(required = true, value = "Collection limit remaining for the day (reset at 00:00 UTC).")
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.balance, account.balance) && Objects.equals(this.currency, account.currency)
				&& Objects.equals(this.key, account.key) && Objects.equals(this.agentId, account.agentId)
	...
	@Override
	public int hashCode() {
		return Objects.hash(balance, currency, key, agentId, agentName, agentAddress, agentPhonenumber, companyName,
				companyAddress, companyPhonenumber, limitMax, limitRemaining);
	}
