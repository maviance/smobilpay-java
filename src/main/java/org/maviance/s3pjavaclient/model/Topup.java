...
public class Topup {
   ...
   * @return serviceid
  **/
  @Schema(required = true, description = "Unique  service Identifier. Idenfies the service this topup package belongs to. Use this value whenever “serviceid” is required in request parameters.")
   ...
   * @return merchant
  **/
  @Schema(required = true, description = "Unique  merchant code identifying the merchant this topup belongs to.")
   ...
   * @return payItemId
  **/
  @Schema(required = true, description = "Unique  Payment Item ID identifying the topup package to be purchased")
  ...
  **/
   ...
   * @return amountType
  **/
  @Schema(required = true, description = "'Supported amount type for the payment of this product:' '\"FIXED\" -> Topup needs to be paid in full by the amount provided in \"amount\"' '\"CUSTOM\" -> Amount must be freely entered' ")
  ...
  **/
   ...
   * @return name
  **/
  @Schema(required = true, description = "Customer friendly name for topup package to be displayed")
  ...
  **/
  @Schema(description = "Cost of topup package in local currency – only set for FIXED amounts.Otherwise null .")
   ...
   * @return description
  **/
  @Schema(description = "Optional description of topup package")
