...
public final class MasterdataApi {
     ...
     * service id.
     */
    public List<Product> products(Long serviceid) {
     ...
     */
    public List<Product> vouchers(Long serviceid) {
    ...
    public List<Topup> topups(Long serviceid) {
    ...
    public List<Cashin> cashins(Long serviceid) {
    ...
    public List<Cashout> cashouts(Long serviceid) {
